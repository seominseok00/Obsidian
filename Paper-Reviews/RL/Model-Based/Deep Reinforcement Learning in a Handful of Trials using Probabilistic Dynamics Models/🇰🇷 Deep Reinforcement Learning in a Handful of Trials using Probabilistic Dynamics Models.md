...
[[📚 Neural network dynamics for Model-Based Deep Reinforcement Learning with Model-Free Fine-Tuning]] 이 논문은 같은 연도 ICRA 2018에 출판된 논문인데 (같은 Sergey-Levine 연구실), 이 논문에서는 `deterministic NN + MPC + random shooting`을 사용
